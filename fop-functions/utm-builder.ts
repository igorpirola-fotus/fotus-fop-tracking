// utm-builder.ts — lógica pura de montagem de UTM (portada de supabase/functions/_shared/utm-builder.ts).
// Sem dependência de Supabase: só transformação de string. Usada por generate-utm no server.ts.
export type Canal = {
  plataforma: string;
  utm_source: string;
  utm_medium: string;
